...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_js__ = __webpack_require__(1);
...
$.fn.projSelector = function(options){
    ...
    me.init = function(){
        ...
        if(window.localStorage){
            ...
            var APPID = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__utils_js__["getAPPID"])();
 ...
 (function($){
    ...
    $.extend($.PaginationRenderers.defaultRenderer.prototype, {
        ...
        getLinks:function(current_page, eventHandler) {
            var begin, end,
                interval = this.pc.getInterval(current_page),   // 分页链接的起始值
                np = this.pc.numPages(),                        // 页数最大值
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__libs_jquery_pagination_js__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__libs_jquery_pagination_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__libs_jquery_pagination_js__);
...
var HOST = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__utils_js__["setHost"])();
var APPID = 12;
...
$(function(){
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__utils_js__["listenChange"])(sendReqs);
    ...
    function sendReqs(objDate){
        ...
        if(objDate){
            ...
            var todayStr = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__utils_js__["getDateStr"])(0);
            date = {
                start:todayStr,
                end:todayStr
            }
    ...
    function getTableDetails(date){
        ...
        var IDsObj = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__utils_js__["getIDs"])();
        var reqOption ={
            start:date.start,
            end: date.end,
        ...
        $.get(HOST+"historyTrends/getTableDetails", reqOption, function(res){
            ...
            // 启动次数
            var startup = __WEBPACK_IMPORTED_MODULE_3_highcharts___default.a.chart('startUpCounts', setParams(startupData, '启动次数'));
            // 新增用户
            var newuser = __WEBPACK_IMPORTED_MODULE_3_highcharts___default.a.chart('newUsers', setParams(newuserData, '新增用户'));
            // 活跃用户
            var activechart = __WEBPACK_IMPORTED_MODULE_3_highcharts___default.a.chart('activeUsers', setParams(activeData, '活跃用户'));
            // 自定义事件
            var customchart = __WEBPACK_IMPORTED_MODULE_3_highcharts___default.a.chart('cusEventsCounts', setParams(customData, '自定义事件发生次数'));
            // 晓莉代码end
        });
    ...
    function initSelector(){
        ...
        $.get(HOST+"/systemInfo/getProjsAndVers", function(res){
            ...
            if(jsonRes && jsonRes.type==="success"){
                ...
                */
                localStorage.setItem("projsAndVersStr",__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__utils_js__["resFormatToString"])(res));
